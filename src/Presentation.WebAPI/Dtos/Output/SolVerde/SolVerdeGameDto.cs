// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SolVerdeGameDto.cs" company="HumbleBets">
...
{
    /// <summary>
    /// <see cref="SolVerdeGameDto"/>
    /// </summary>
    public class SolVerdeGameDto
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SolVerdeGameDto"/> class.
        /// </summary>
        public SolVerdeGameDto()
        {
        ...
        public List<SolVerdeOddDto> Odds { get; init; }
