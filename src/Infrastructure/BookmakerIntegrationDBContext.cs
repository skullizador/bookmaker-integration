...
namespace BookmakerIntegration.Infrastructure
{
    using System;
    using System.Linq;
    ...
    /// <summary>
    /// <see cref="BookmakerIntegrationDBContext"/>
    /// </summary>
    /// <seealso cref="DbContext"/>
    /// <seealso cref="IUnitOfWork"/>
    public class BookmakerIntegrationDBContext : DbContext, IUnitOfWork
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BookmakerIntegrationDBContext"/> class.
        /// </summary>
        /// <param name="configuration">The configuration.</param>
        /// <param name="mediator">The mediator.</param>
        public BookmakerIntegrationDBContext(
            IConfiguration configuration,
            IMediator mediator,
            DbContextOptions<BookmakerIntegrationDBContext> options)
            : base(options)
        {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder
                ...
                .UseMySql(
                    this.configuration.GetSection(BookmakerIntegrationDBContext.DatabaseConnectionSection).Value,
